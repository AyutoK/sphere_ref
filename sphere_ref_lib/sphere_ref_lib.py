...
from sphere_ref_lib import target_param as tp
...
# srl.get_default_param()はtarget_param.pyに移行
...
def ii_the_reflection_rate(target, R2, ste_da, fp_nc, apply_ref="average", fn="alpha_to_theta_forhist_ver2.nc"):
    ...
    e0 = 1.0
    e1, e2, H_obs, D_moon, R_moon, e1, e2, tandelta = tp.get_default_param(target)
